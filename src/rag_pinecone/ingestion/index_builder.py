...
def parse_standard_metadata(file_path: str) -> dict:
    ...
    # find '3500' or '3500.2'
    if compact:
       part = compact.group(1)
       year = int(compact.group(2))
       series_key = f"3500.{part}"
    else:
       series_key = None
       year = None
...
def parse_standard_metadata(file_path: str) -> dict:
    ...
    # Handles:
    # ASNZS-3500-22025 (2).pdf
    # ASNZS-3500-42021 part 4.pdf
    compact = re.search(
        r"3500-(\d)((?:19|20)\d{2})",
        filename,
        re.IGNORECASE,
    ...
    if compact:
        ...
        # Handles:
        # Part 4 Heated water services AS NZS 3500 4 2003.pdf
        spaced = re.search(
            r"3500[\s._-]+([1-9])[\s._-]+((?:19|20)\d{2})",
            filename,
            re.IGNORECASE,
        )
...
if __name__ == "__main__":
    test_files = [
        "ASNZS-3500-12025 (1).pdf",
        "ASNZS-3500-22025 (2).pdf",
        "ASNZS-3500-32021 part 3.pdf",
        "ASNZS-3500-42021 part 4.pdf",
    ]

    for file in test_files:
        print(parse_standard_metadata(file))'''
